...
TEST_GROUP(<<<STATEMACHINENAME>>>_Test_Suite)
{
	/// {{{USER_TEST_GROUP_FIXTURE_LOCALS}}}
	/// {{{USER_TEST_GROUP_FIXTURE_LOCALS}}}
	void setup(){
		/// {{{USER_TEST_GROUP_FIXTURE_SETUP}}}
		/// {{{USER_TEST_GROUP_FIXTURE_SETUP}}}
	}
	void teardown(){
		/// {{{USER_TEST_GROUP_FIXTURE_TEARDOWN}}}
		/// {{{USER_TEST_GROUP_FIXTURE_TEARDOWN}}}
	}
};

TEST(<<<STATEMACHINENAME>>>_Test_Suite, Test<<<STATEMACHINENAME>>>_States)
{
